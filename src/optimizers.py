...
class Optimizer(ABC):
    ...
    @abstractmethod
    def __init__(self, net, loss, metr, lr, lr_decay, limit_step, momentum, lambd, reg_type):
...
class GradientDescent(Optimizer, ABC):
    """ Gradient Descent """
    def __init__(self, net, loss, metr, lr, lr_decay, limit_step, momentum, lambd=0., reg_type=None):
