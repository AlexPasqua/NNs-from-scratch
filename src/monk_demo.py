...
if __name__ == '__main__':
    ...
    # model.print_net()
    model.compile(opt='gd', loss='squared', metr='bin_class_acc', lrn_rate=0.5, momentum=0.25)
    model.fit(inputs=monk1_train, targets=labels, epochs=600, batch_size=len(monk1_train))
